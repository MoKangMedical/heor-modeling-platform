# heor-modeling-platform API文档

## 概述

本文档描述了heor-modeling-platform项目的API接口规范和使用方法。
...
{
  "status": "healthy",
  "service": "heor-modeling-platform",
  "version": "1.0.0"
}
```
...
class HeormodelingplatformClient:
...
```python
# 初始化客户端
client = HeormodelingplatformClient(
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/var/log/heor-modeling-platform/app.log'),
...
- 项目主页: https://github.com/MoKangMedical/heor-modeling-platform
