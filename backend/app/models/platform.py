...
class ModelVersion(Base):
    ...
    base_version_id: Mapped[UUID | None] = mapped_column(PGUUID(as_uuid=True), nullable=True)
    graph_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    model_ir_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    expression_catalog_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
...
class ModelTransition(Base):
    ...
    probability_function_id: Mapped[UUID | None] = mapped_column(PGUUID(as_uuid=True), nullable=True)
